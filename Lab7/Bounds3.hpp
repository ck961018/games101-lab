...
inline bool Bounds3::IntersectP(const Ray &ray, const Vector3f &invDir,
  ...
  auto t_min_x = (pMin.x - ray.origin.x) * invDir.x;
  auto t_min_y = (pMin.y - ray.origin.y) * invDir.y;
  auto t_min_z = (pMin.z - ray.origin.z) * invDir.z;
  auto t_max_x = (pMax.x - ray.origin.x) * invDir.x;
  auto t_max_y = (pMax.y - ray.origin.y) * invDir.y;
  auto t_max_z = (pMax.z - ray.origin.z) * invDir.z;
